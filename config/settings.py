...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-z7*^b9%07kfg3nv+m&)%!2w3qoj5nz!c_g3^3o9w!y!9zg90hh')
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "catalog.Product": "fas fa-shopping-bag",
        "portfolio.Project": "fas fa-project-diagram",
        "blog.Post": "fas fa-newspaper",
        "leads.Inquiry": "fas fa-envelope",
    },
